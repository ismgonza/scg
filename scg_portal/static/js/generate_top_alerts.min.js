function generateTopAlertsTable(data, currentPage = 1, pageSize = 10, containerId = 'top_alerts') {
    ...
    tableHTML += '<tr><th data-i18n="reports.security_details_report.vuln_name"> </th><th data-i18n="reports.security_details_report.risk_category">Risk Category</th><th data-i18n="reports.security_details_report.count">Count</th></tr>';
